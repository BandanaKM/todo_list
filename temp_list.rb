...
#delete these two methods and assign checkbox status at List#display_list method
  def check_off_task
    self.description.gsub!("[ ]", "[X]")
  end
...
#I want to be able to complete tasks by typing complete followed by task number
